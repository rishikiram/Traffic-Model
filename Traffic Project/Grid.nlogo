...
globals[cars-waiting CWS num-of-sums]
...
true
false
"" "set-plot-pen-color black\nif stoplight-cycle-length <= 200  [set-plot-pen-color red]\nif stoplight-cycle-length <= 150 [set-plot-pen-color orange]\nif stoplight-cycle-length <= 150 [set-plot-pen-color green]\nif stoplight-cycle-length <= 100 [set-plot-pen-color cyan]\nif stoplight-cycle-length <= 75 [set-plot-pen-color blue]\nif stoplight-cycle-length <= 50 [set-plot-pen-color violet]\nif stoplight-cycle-length <= 25 [set-plot-pen-color magenta]\nif stoplight-cycle-length <= 1 [set-plot-pen-color black]"
PENS
"default" 1.0 0 -11221820 true "" "if count cars > 0 and ticks > 1000[plot (cars-waiting) * 100 / (count cars)]"
"pen-1" 1.0 0 -7500403 true "" ";if num-of-sums > 0[plot 100 * (CWS / num-of-sums)/ count cars]"
